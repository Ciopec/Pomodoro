...
public class Home {
    private final AudioClip mAudioFocus;
    private final AudioClip mAudioPause;
    ...
    public Home() {
        ...
        setTimerText(0);
        mAudioFocus = new AudioClip(getClass().getResource("/sounds/Focus.m4a").toExternalForm());
        mAudioPause = new AudioClip(getClass().getResource("/sounds/Pause.m4a").toExternalForm());
    }
